...
export function FeedbackSuccessSteps({ onFeedbackRestartRequest }: FeedbackSuccessStepsProps) {
  return (
    <>
      <header className="w-full flex justify-end items-end">
        <CloseButton />
      </header>
      <div className="flex flex-col items-center py-10 w-[304px] gap-4">
        ...
        <span className="text-xl">Feedback registrado</span>

        <button
          type="button"
          className="py-2 px-6 bg-zinc-800 rounded-md border-transparent 
